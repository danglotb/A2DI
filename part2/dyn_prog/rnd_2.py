...
if (len(sys.argv) > 1):
	...
	for y in range(sizey):
		...
		print("Pour crée un maze, donné en argument un entier representant le nombre de mur")
		print("Les murs seront placés aléatoirement (sauf sur les case A et B)")

print("Gridworld : Politique aléatoire avec un aléatoire (15%) sur le résultat de l'action")
